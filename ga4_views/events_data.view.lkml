...
view: events_data__items {
  ...
  dimension: events_data__items {
    type: string
    hidden: yes
    sql: events_data__items ;;
  }
...
view: events_data__event_params {

  dimension: events_data__event_params {
    type: string
    hidden: yes
    sql: events_data__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_data__user_properties {

  dimension: events_data__user_properties {
    type: string
    hidden: yes
    sql: events_data__user_properties ;;
  }
  dimension: key {
    type: number
    sql: key ;;
